...
const Inner = styled.div`
  ...
  ${mq[0]} { padding: ${rhythm(10/12)} ${rhythm(10/12)} ${rhythm(8/12)}; }
  ${mq[2]} { padding: ${rhythm(14/12)} ${rhythm(10/12)} ${rhythm(10/12)}; }
`
...
const List = styled.ul`
  ...
  ${mq[0]} { padding: 0 ${rhythm(10/12)}; }
  ${mq[2]} { padding: 0 ${rhythm(10/12)}; }
  list-style: none;
  display: flex;
  flex-wrap: wrap;
  max-width: 920px;
