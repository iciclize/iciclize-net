...
<p>
出身: &ensp;神奈川県横浜市<br/>
資格: &ensp;4級アマチュア無線技士(コールサイン: <code>JJ1QJI</code>)<br/>
趣味: &ensp;プログラミング/開発, 音楽/ピアノ/耳コピ<br/>
</p>

くだらないものを作るのが好きで、最近では画像を野獣先輩にすり替える悪いルーターを作りました。

今は組み込み技術と高校数学IIIを勉強しています。大学3年生にもなって高校数学ってマジ？
...
大学2年生の3月から9月まで松屋で働いてました。民度の低さを期待していたのに思いの外普通の客ばかりでしたね。

時間が惜しいので基本的にアルバイトはしません。

## 軽い経歴

中学1年生の終わり頃にプログラミングに出会い、HSP言語を中心にWebページを書いて遊んだりしていました。

高校時代はWebを中心にAndroidアプリなど作って遊んだり、ちょっとコンテストに出たりイベントやハンズオンの聴講に行ったりもしていました。
学校の勉強はお構いなしに好き勝手やっていたので成績は散々でしたが、なんとAO入学で筑波大学に入れてもらえました。

大学に入学するも、まるで高校数学を勉強していなかったので数学の単位を落としまくっています。
