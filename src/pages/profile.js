  ...
  <Layout>
    ...
    <PostContainer>
      ...
      <PostInner pageWidth={pageWidth}>
        ...
        <p>⚠️ 2026-05-07 工事中 ⚠️</p>
        <p>1998年生まれ（27歳）。男性。神奈川県横浜市出身。横浜市在住。</p>
        ...
        >
          ...
          <StaticImage
            css={css`
              flex: 0 0 200px;
            `}
            src="https://nnyapi.iciclize.net/uploads/20260426_yino_1_89cb2604c6.jpeg"
            alt="Y.Ino profile image 1 2026-04-26"
          />
          <StaticImage
            css={css`
              flex: 0 0 200px;
            `}
            src="https://nnyapi.iciclize.net/uploads/20260426_yino_2_a7c912254d.jpeg"
            alt="Y.Ino profile image 2 2026-04-26"
          />
          <StaticImage
            css={css`
              flex: 0 0 200px;
            `}
            src="https://nnyapi.iciclize.net/uploads/20260426_yino_3_c67672bc93.jpeg"
            alt="Y.Ino profile image 3 2026-04-26"
          />
        </div>
